        ...
        <div>
            ...
            <ul >
                <h3>Lista de Usuarios</h3>
                {
                    ...
                    <button id='botones'  onClick={() => edit(elemento)} className='m-3 btn btn-info' type='submit'>Editar</button>
                    <button id='botones' onClick={() => deleteUser(elemento)} className='m-3 btn btn-danger' type='submit'>Eliminar</button> </li>))
                }
